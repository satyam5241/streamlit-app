...
st.header(""" Exploring different classifier on different datasets """)

dataset_name = st.sidebar.selectbox("Select Database", ("Iris", "Breast Cancer", "Wine Dataset"))
